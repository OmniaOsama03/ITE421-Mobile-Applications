...
public class PuzzleGameView extends RelativeLayout {
    ...
    public void buildGuiByCode( Activity activity, int width, int height,
        ...
        for( int i = 0; i < tvs.length; i++ ) {
            ...
            //changed the rbg range from 155 to 254 (base- 155, random- 0-99)
            int red = 155 + random.nextInt(100);
    ...
    public void fillGui( String [] scrambledText ) {
        //Note! Because DynamicSizing.java had not been provided to us, I commented it out in case you didn't want us to add it ourselves
